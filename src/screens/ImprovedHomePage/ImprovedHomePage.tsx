...
export const ImprovedHomePage = (): JSX.Element => {
  ...
  // Brands
  const brands = [
    { name: "Joie", logo: "/images/brand-joie.png" },
    { name: "Chicco", logo: "/images/brand-chicco.png" },
    { name: "Mothercare", logo: "/images/brand-mothercare.png" },
    { name: "Fisher-Price", logo: "/images/brand-fisher-price.png" },
    { name: "Aptamil", logo: "/images/brand-aptamil.png" },
    { name: "Babylove", logo: "/images/brand-babylove.png" },  ];
